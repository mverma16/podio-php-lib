...
class ResellerController extends Controller
{
     ...
     * @return type
     */
    public function GetDomain($domain, $userid, $apikey)
    {
     ...
     * @return type
     */
    public function GetCustomerbyId($customer_id, $userid, $apikey)
    {
     ...
     * @return type
     */
    public function GetCustomerbyUserName($customer_username, $userid, $apikey)
    {
     ...
     * @return type Array
     */
    public function Signup($email, $userid, $apikey, $password, $name, $company = 'not available', $address = 'not avalable', $city = 'not available', $state = 'not avalable', $country = 'IN', $zip = '560076', $phonecc = '+91', $phone = '9999999999', $lang = 'en')
    {
     ...
     * @return type
     */
    public function GenerateToken($ip, $userid, $apikey, $username, $password)
    {
     ...
     * @return type
     */
    public function ChangePassword($userid, $apikey, $customerid, $password)
    {
     ...
     * @return type
     */
    public function ForgotPassword($userid, $apikey, $username)
    {
     ...
     * @return type
     */
    public function getTrasaction($userid, $apikey, $username)
    {
     ...
     * @return type
     */
    public function getsingleDomain_LinuxUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_LinuxIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_LinuxUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_LinuxHK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_LinuxTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getWebservices($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_WindowsUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_WindowsUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_WindowsIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_WindowsHK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getsingleDomain_WindowsTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_LinuxUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_LinuxUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_LinuxIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_LinuxHK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_LinuxTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_WindowsUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_WindowsUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_WindowsIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_WindowsHK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getmultiDomain_WindowsTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_LinuxUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_LinuxUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_LinuxIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_LinuxTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_WindowsUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_WindowsUK($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_WindowsIN($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getReseller_WindowsTR($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getVPS_LinuxUS($userid, $apikey, $customerid)
    {
     ...
     * @return type
     */
    public function getVPS_LinuxIN($userid, $apikey, $customerid)
    {
    ...
    public function EnterpriseEmail($userid, $apikey, $customerid)
    {
    ...
    public function BusinessEmail($userid, $apikey, $customerid)
    {
    ...
    public function DedicatedServer($userid, $apikey, $customerid)
    {
    ...
    public function ManagedServer($userid, $apikey, $customerid)
    {
    ...
    public function SiteLock($userid, $apikey, $customerid)
    {
    ...
    public function CodeGuard($userid, $apikey, $customerid)
    {
    ...
    public function GetDomainReg($userid, $apikey, $customerid)
    {
    ...
    public function Ssl($userid, $apikey, $customerid)
    {
    ...
    public function test($userid, $apikey, $url, $domain)
    {
        try {
